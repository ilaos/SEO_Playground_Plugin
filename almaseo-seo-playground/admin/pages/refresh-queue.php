...
<div class="wrap almaseo-rq-wrap">
    ...
    <h1 class="almaseo-rq-title"><?php esc_html_e( 'Refresh Queue', 'almaseo-seo-playground' ); ?></h1>

    <!-- Feature Intro -->
    <div class="almaseo-rq-intro">
        <p class="almaseo-rq-intro-lead">
            <?php esc_html_e( 'Focus your refresh work on the pages that matter most. AlmaSEO scores every published page by business value, traffic trends, conversion potential, and opportunity size — then ranks them so you know exactly what to update next.', 'almaseo-seo-playground' ); ?>
        </p>
        ...
        <p class="almaseo-rq-intro-note">
            ...
            <?php esc_html_e( 'Signal weights are adjustable. Open Settings below the table to emphasize the signals that matter most to your business.', 'almaseo-seo-playground' ); ?>
        </p>
    </div>
    ...
    <div class="almaseo-rq-stats" id="almaseo-rq-stats">
        <div class="almaseo-rq-stat-card">
            ...
            <div class="almaseo-rq-stat-label"><?php esc_html_e( 'Total Queued', 'almaseo-seo-playground' ); ?></div>
        </div>
        <div class="almaseo-rq-stat-card almaseo-rq-stat-high">
            <span class="dashicons dashicons-flag"></span>
            <div class="almaseo-rq-stat-value" id="almaseo-rq-high">—</div>
            <div class="almaseo-rq-stat-label"><?php esc_html_e( 'High Priority', 'almaseo-seo-playground' ); ?></div>
        </div>
        <div class="almaseo-rq-stat-card almaseo-rq-stat-medium">
            <span class="dashicons dashicons-marker"></span>
            <div class="almaseo-rq-stat-value" id="almaseo-rq-medium">—</div>
            <div class="almaseo-rq-stat-label"><?php esc_html_e( 'Medium Priority', 'almaseo-seo-playground' ); ?></div>
        </div>
        <div class="almaseo-rq-stat-card almaseo-rq-stat-low">
            <span class="dashicons dashicons-minus"></span>
            <div class="almaseo-rq-stat-value" id="almaseo-rq-low">—</div>
            <div class="almaseo-rq-stat-label"><?php esc_html_e( 'Low Priority', 'almaseo-seo-playground' ); ?></div>
        </div>
    </div>
    ...
    <div class="almaseo-rq-actions">
        ...
        <select id="almaseo-rq-status-filter" class="almaseo-rq-select">
            ...
            <option value="queued"><?php esc_html_e( 'Queued', 'almaseo-seo-playground' ); ?></option>
            <option value="skipped"><?php esc_html_e( 'Skipped', 'almaseo-seo-playground' ); ?></option>
            <option value="refreshed"><?php esc_html_e( 'Refreshed', 'almaseo-seo-playground' ); ?></option>
        </select>

        <select id="almaseo-rq-tier-filter" class="almaseo-rq-select">
            <option value=""><?php esc_html_e( 'All priorities', 'almaseo-seo-playground' ); ?></option>
    ...
    <table class="widefat striped almaseo-rq-table" id="almaseo-rq-table">
        <thead>
            <tr>
                ...
                <th class="almaseo-rq-col-score"><?php esc_html_e( 'Priority', 'almaseo-seo-playground' ); ?></th>
                <th class="almaseo-rq-col-signal"><?php esc_html_e( 'Business', 'almaseo-seo-playground' ); ?></th>
                <th class="almaseo-rq-col-signal"><?php esc_html_e( 'Traffic', 'almaseo-seo-playground' ); ?></th>
                <th class="almaseo-rq-col-signal"><?php esc_html_e( 'Intent', 'almaseo-seo-playground' ); ?></th>
                <th class="almaseo-rq-col-signal"><?php esc_html_e( 'Opportunity', 'almaseo-seo-playground' ); ?></th>
    ...
    <details class="almaseo-rq-settings" id="almaseo-rq-settings">
        <summary class="almaseo-rq-settings-toggle">
            ...
            <?php esc_html_e( 'Signal Weights', 'almaseo-seo-playground' ); ?>
        </summary>
        <div class="almaseo-rq-settings-body">
            <p class="almaseo-rq-settings-desc">
                <?php esc_html_e( 'Adjust how much each signal contributes to the priority score. Weights are normalized — they don\'t need to add up to exactly 100.', 'almaseo-seo-playground' ); ?>
            </p>
            <div class="almaseo-rq-weight-row">
                <label><?php esc_html_e( 'Business Value', 'almaseo-seo-playground' ); ?></label>
                <input type="number" id="almaseo-rq-w-bv" min="0" max="100" value="25">
            </div>
            <div class="almaseo-rq-weight-row">
                <label><?php esc_html_e( 'Traffic Decline', 'almaseo-seo-playground' ); ?></label>
                <input type="number" id="almaseo-rq-w-td" min="0" max="100" value="30">
            </div>
            <div class="almaseo-rq-weight-row">
                <label><?php esc_html_e( 'Conversion Intent', 'almaseo-seo-playground' ); ?></label>
                <input type="number" id="almaseo-rq-w-ci" min="0" max="100" value="20">
            </div>
            <div class="almaseo-rq-weight-row">
                <label><?php esc_html_e( 'Opportunity Size', 'almaseo-seo-playground' ); ?></label>
                <input type="number" id="almaseo-rq-w-os" min="0" max="100" value="25">
            </div>
            <button id="almaseo-rq-save-settings" class="button button-primary"><?php esc_html_e( 'Save Weights', 'almaseo-seo-playground' ); ?></button>
