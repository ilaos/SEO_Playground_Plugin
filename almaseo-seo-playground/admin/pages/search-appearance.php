...
<div class="wrap almaseo-sa-wrap">
    <h1><?php esc_html_e( 'Search Appearance', 'almaseo' ); ?></h1>
    <p class="description"><?php esc_html_e( 'Configure how your content appears in search engines. Set default title and description templates for each content type, and control search visibility.', 'almaseo' ); ?></p>

    <div class="almaseo-sa-notice" id="almaseo-sa-notice" style="display:none;"></div>

    <nav class="almaseo-sa-tabs">
        <a href="#" class="almaseo-sa-tab active" data-tab="content-types"><?php esc_html_e( 'Content Types', 'almaseo' ); ?></a>
        <a href="#" class="almaseo-sa-tab" data-tab="taxonomies"><?php esc_html_e( 'Taxonomies', 'almaseo' ); ?></a>
        <a href="#" class="almaseo-sa-tab" data-tab="archives"><?php esc_html_e( 'Archives', 'almaseo' ); ?></a>
        <a href="#" class="almaseo-sa-tab" data-tab="special"><?php esc_html_e( 'Special Pages', 'almaseo' ); ?></a>
        <a href="#" class="almaseo-sa-tab" data-tab="separator"><?php esc_html_e( 'Separator', 'almaseo' ); ?></a>
    </nav>

    <!-- Content Types Tab -->
    <div class="almaseo-sa-panel active" id="panel-content-types">
        <h2><?php esc_html_e( 'Post Types', 'almaseo' ); ?></h2>
        ...
        <div class="almaseo-sa-card">
            ...
            <table class="form-table">
                <tr>
                    <th><label><?php esc_html_e( 'SEO Title', 'almaseo' ); ?></label></th>
                    <td>
                        ...
                        <p class="description"><?php esc_html_e( 'Use smart tags like %%title%%, %%sep%%, %%sitename%%.', 'almaseo' ); ?>
                            <a href="#" class="almaseo-sa-tags-ref"><?php esc_html_e( 'View all tags', 'almaseo' ); ?></a>
                        </p>
                    </td>
                </tr>
                <tr>
                    <th><label><?php esc_html_e( 'Meta Description', 'almaseo' ); ?></label></th>
                    <td>
                        <input type="text" class="large-text almaseo-sa-input"
                ...
                <tr>
                    <th><label><?php esc_html_e( 'Show in Search Results', 'almaseo' ); ?></label></th>
                    <td>
                        <label>
                            ...
                            <?php esc_html_e( 'Noindex this post type (prevent indexing by default)', 'almaseo' ); ?>
                        </label>
                    </td>
                </tr>
            </table>
        ...
        <!-- Attachments -->
        <div class="almaseo-sa-card">
            <h3><?php esc_html_e( 'Attachments / Media', 'almaseo' ); ?></h3>
            <table class="form-table">
                <tr>
                    <th><label><?php esc_html_e( 'Redirect to Parent', 'almaseo' ); ?></label></th>
                    <td>
                        <label>
                            <input type="checkbox" class="almaseo-sa-input"
                            ...
                            <?php esc_html_e( 'Redirect attachment pages to parent post (301 redirect)', 'almaseo' ); ?>
                        </label>
                    </td>
                </tr>
                <tr>
                    <th><label><?php esc_html_e( 'Noindex', 'almaseo' ); ?></label></th>
                    <td>
                        <label>
                            <input type="checkbox" class="almaseo-sa-input"
                            ...
                            <?php esc_html_e( 'Prevent attachment pages from being indexed', 'almaseo' ); ?>
                        </label>
                    </td>
                </tr>
            </table>
    ...
    <div class="almaseo-sa-panel" id="panel-taxonomies">
        <h2><?php esc_html_e( 'Taxonomies', 'almaseo' ); ?></h2>
                ...
                <tr>
                    ...
                    <td>
                        <label>
                            ...
                            <?php esc_html_e( 'Noindex this taxonomy (prevent indexing by default)', 'almaseo' ); ?>
                        </label>
                    </td>
                </tr>
            </table>
    ...
    <div class="almaseo-sa-panel" id="panel-archives">
        <h2><?php esc_html_e( 'Archives', 'almaseo' ); ?></h2>

        <!-- Author Archives -->
        <div class="almaseo-sa-card">
            <h3><?php esc_html_e( 'Author Archives', 'almaseo' ); ?></h3>
            <table class="form-table">
                <tr>
                    <th><label><?php esc_html_e( 'SEO Title', 'almaseo' ); ?></label></th>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <label>
                            ...
                            <?php esc_html_e( 'Noindex author archives', 'almaseo' ); ?>
                        </label>
                    </td>
                </tr>
            </table>
        ...
        <!-- Date Archives -->
        <div class="almaseo-sa-card">
            <h3><?php esc_html_e( 'Date Archives', 'almaseo' ); ?></h3>
            <table class="form-table">
                <tr>
                    <th><label><?php esc_html_e( 'SEO Title', 'almaseo' ); ?></label></th>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <label>
                            ...
                            <?php esc_html_e( 'Noindex date archives (recommended)', 'almaseo' ); ?>
                        </label>
                    </td>
                </tr>
            </table>
    ...
    <div class="almaseo-sa-panel" id="panel-special">
        <h2><?php esc_html_e( 'Special Pages', 'almaseo' ); ?></h2>

        <!-- Homepage -->
        <div class="almaseo-sa-card">
            <h3><?php esc_html_e( 'Homepage', 'almaseo' ); ?></h3>
            <table class="form-table">
                <tr>
                    <th><label><?php esc_html_e( 'SEO Title', 'almaseo' ); ?></label></th>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <textarea class="large-text almaseo-sa-input" rows="3"
                                  ...
                                  placeholder="<?php esc_attr_e( 'Enter a meta description for your homepage', 'almaseo' ); ?>"><?php echo esc_textarea( isset( $settings['special']['homepage']['description_template'] ) ? $settings['special']['homepage']['description_template'] : '' ); ?></textarea>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <!-- Search Results -->
        <div class="almaseo-sa-card">
            <h3><?php esc_html_e( 'Search Results', 'almaseo' ); ?></h3>
            <table class="form-table">
                <tr>
                    <th><label><?php esc_html_e( 'SEO Title', 'almaseo' ); ?></label></th>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <label>
                            ...
                            <?php esc_html_e( 'Noindex search results pages (recommended)', 'almaseo' ); ?>
                        </label>
                    </td>
                </tr>
            </table>
        ...
        <!-- 404 -->
        <div class="almaseo-sa-card">
            <h3><?php esc_html_e( '404 Page', 'almaseo' ); ?></h3>
            <table class="form-table">
                <tr>
                    <th><label><?php esc_html_e( 'SEO Title', 'almaseo' ); ?></label></th>
                    <td>
    ...
    <div class="almaseo-sa-panel" id="panel-separator">
        <h2><?php esc_html_e( 'Title Separator', 'almaseo' ); ?></h2>
        <p class="description"><?php esc_html_e( 'Choose the separator character used in the %%sep%% smart tag.', 'almaseo' ); ?></p>
    ...
    <div class="almaseo-sa-actions">
        <button type="button" class="button button-primary" id="almaseo-sa-save">
            <?php esc_html_e( 'Save Changes', 'almaseo' ); ?>
        </button>
    ...
    <div class="almaseo-sa-modal" id="almaseo-sa-tags-modal" style="display:none;">
        <div class="almaseo-sa-modal-content">
            <div class="almaseo-sa-modal-header">
                <h3><?php esc_html_e( 'Available Smart Tags', 'almaseo' ); ?></h3>
            ...
            <div class="almaseo-sa-modal-body">
                <table class="widefat striped">
                    <thead>
                        <tr>
                            <th><?php esc_html_e( 'Tag', 'almaseo' ); ?></th>
