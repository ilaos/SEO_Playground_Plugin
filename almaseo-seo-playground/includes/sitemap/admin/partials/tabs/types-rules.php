        ...
        <div class="almaseo-sitemap-types">
            <div class="almaseo-toggle-group">
                ...
                <label class="almaseo-toggle-item">
                    ...
                    <span><?php _e('Author Archives', 'almaseo'); ?></span>
                    <small><?php _e('Include author/user archive pages', 'almaseo'); ?></small>
                </label>
            </div>
        </div>
    </div>
...
<div class="almaseo-card">
    ...
    <div class="almaseo-card-body">
        ...
        <div class="almaseo-advanced-rules-section">
            <h3><?php _e('Advanced Exclusion Rules', 'almaseo'); ?></h3>
            <p class="description" style="margin-bottom: 15px;">
                <?php _e('Exclude specific content from your sitemaps based on taxonomy, author, or age.', 'almaseo'); ?>
            </p>
            ...
            <div class="almaseo-form-group">
                <label for="exclude-taxonomies"><?php _e('Exclude by Category/Tag', 'almaseo'); ?></label>
                <select id="exclude-taxonomies" class="almaseo-input almaseo-select-multiple" multiple="multiple" style="min-height: 120px; width: 100%;">
                    <?php if (!empty($categories) && !is_wp_error($categories)) : ?>
                        <optgroup label="<?php esc_attr_e('Categories', 'almaseo'); ?>">
                    ...
                    <?php if (!empty($tags) && !is_wp_error($tags)) : ?>
                        <optgroup label="<?php esc_attr_e('Tags', 'almaseo'); ?>">
                ...
                <p class="description"><?php _e('Posts in selected categories/tags will be excluded from the sitemap. Hold Ctrl/Cmd to select multiple.', 'almaseo'); ?></p>
            </div>

            <div class="almaseo-form-group">
                <label for="exclude-authors"><?php _e('Exclude by Author', 'almaseo'); ?></label>
                ...
                <p class="description"><?php _e('Posts by selected authors will be excluded from the sitemap.', 'almaseo'); ?></p>
            </div>

            <div class="almaseo-form-group">
                <label for="exclude-older-than"><?php _e('Exclude Posts Older Than', 'almaseo'); ?></label>
                <select id="exclude-older-than" class="almaseo-input" style="width: auto;">
                    <option value="0" <?php selected($older_than_years, 0); ?>><?php _e('No limit (include all)', 'almaseo'); ?></option>
                    <option value="1" <?php selected($older_than_years, 1); ?>><?php _e('1 year', 'almaseo'); ?></option>
                    <option value="2" <?php selected($older_than_years, 2); ?>><?php _e('2 years', 'almaseo'); ?></option>
                    <option value="3" <?php selected($older_than_years, 3); ?>><?php _e('3 years', 'almaseo'); ?></option>
                    <option value="5" <?php selected($older_than_years, 5); ?>><?php _e('5 years', 'almaseo'); ?></option>
                    <option value="10" <?php selected($older_than_years, 10); ?>><?php _e('10 years', 'almaseo'); ?></option>
                </select>
                <p class="description"><?php _e('Older posts may be less relevant. Excluding them can reduce sitemap size.', 'almaseo'); ?></p>
            </div>
        </div>
    </div>
</div>
