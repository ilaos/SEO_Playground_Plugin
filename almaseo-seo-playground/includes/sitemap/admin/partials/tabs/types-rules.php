...
<div class="almaseo-card">
    <div class="almaseo-card-header">
        <h2><?php esc_html_e('Sitemap Types', 'almaseo-seo-playground'); ?></h2>
        <div class="almaseo-master-toggle">
            ...
            <span><?php esc_html_e('Enable Sitemaps', 'almaseo-seo-playground'); ?></span>
        </div>
    </div>
        ...
        <div class="almaseo-sitemap-types">
            <div class="almaseo-toggle-group">
                <label class="almaseo-toggle-item">
                    ...
                    <span><?php esc_html_e('Posts', 'almaseo-seo-playground'); ?></span>
                </label>
                <label class="almaseo-toggle-item">
                    <input type="checkbox" class="sitemap-type" data-type="pages"
                           <?php checked($settings['include']['pages']); ?>>
                    <span><?php esc_html_e('Pages', 'almaseo-seo-playground'); ?></span>
                </label>
                <label class="almaseo-toggle-item">
                    <input type="checkbox" class="sitemap-type" data-type="cpts"
                           <?php checked($settings['include']['cpts'] === 'all'); ?>>
                    <span><?php esc_html_e('Custom Post Types', 'almaseo-seo-playground'); ?></span>
                    <small><?php esc_html_e('(All public)', 'almaseo-seo-playground'); ?></small>
                </label>
                <label class="almaseo-toggle-item">
                    <input type="checkbox" class="sitemap-type" data-type="category"
                           data-taxonomy="true"
                           <?php checked($settings['include']['tax']['category']); ?>>
                    <span><?php esc_html_e('Categories', 'almaseo-seo-playground'); ?></span>
                </label>
                <label class="almaseo-toggle-item">
                    <input type="checkbox" class="sitemap-type" data-type="post_tag"
                           data-taxonomy="true"
                           <?php checked($settings['include']['tax']['post_tag']); ?>>
                    <span><?php esc_html_e('Tags', 'almaseo-seo-playground'); ?></span>
                </label>
                <label class="almaseo-toggle-item">
                    <input type="checkbox" class="sitemap-type" data-type="users"
                           <?php checked($settings['include']['users']); ?>>
                    <span><?php esc_html_e('Author Archives', 'almaseo-seo-playground'); ?></span>
                    <small><?php esc_html_e('Include author/user archive pages', 'almaseo-seo-playground'); ?></small>
                </label>
            </div>
        </div>
    </div>
...
<div class="almaseo-card">
    <div class="almaseo-card-header">
        <h2><?php esc_html_e('Sitemap Rules', 'almaseo-seo-playground'); ?></h2>
    </div>
    <div class="almaseo-card-body">
        <div class="almaseo-form-group">
            <label for="links-per-sitemap"><?php esc_html_e('Links per sitemap:', 'almaseo-seo-playground'); ?></label>
            ...
            <p class="description"><?php esc_html_e('Number of URLs per sitemap file (1-50000, default: 1000)', 'almaseo-seo-playground'); ?></p>
        </div>
        
        <!-- Performance Settings -->
        <div class="almaseo-form-group">
            <h3><?php esc_html_e('Performance', 'almaseo-seo-playground'); ?></h3>
            <div class="almaseo-toggle-group">
                <label class="almaseo-toggle-item">
                    <input type="radio" name="storage_mode" value="static" 
                           <?php checked($settings['perf']['storage_mode'], 'static'); ?>>
                    <span><?php esc_html_e('Static Mode', 'almaseo-seo-playground'); ?></span>
                    <small><?php esc_html_e('Pre-generate files for best performance', 'almaseo-seo-playground'); ?></small>
                </label>
                <label class="almaseo-toggle-item">
                    <input type="radio" name="storage_mode" value="dynamic" 
                           <?php checked($settings['perf']['storage_mode'], 'dynamic'); ?>>
                    <span><?php esc_html_e('Dynamic Mode', 'almaseo-seo-playground'); ?></span>
                    <small><?php esc_html_e('Generate on-demand', 'almaseo-seo-playground'); ?></small>
                </label>
            </div>
            <label class="almaseo-toggle-item" style="margin-top: 10px;">
                <input type="checkbox" id="enable-gzip" 
                       <?php checked($settings['perf']['gzip']); ?>>
                <span><?php esc_html_e('Enable Gzip Compression', 'almaseo-seo-playground'); ?></span>
                <small><?php esc_html_e('Reduce bandwidth usage', 'almaseo-seo-playground'); ?></small>
            </label>
        </div>
        
        <div class="almaseo-advanced-rules-section">
            <h3><?php esc_html_e('Advanced Exclusion Rules', 'almaseo-seo-playground'); ?></h3>
            <p class="description" style="margin-bottom: 15px;">
                <?php esc_html_e('Exclude specific content from your sitemaps based on taxonomy, author, or age.', 'almaseo-seo-playground'); ?>
            </p>
            ...
            <div class="almaseo-form-group">
                <label for="exclude-taxonomies"><?php esc_html_e('Exclude by Category/Tag', 'almaseo-seo-playground'); ?></label>
                ...
                <p class="description"><?php esc_html_e('Posts in selected categories/tags will be excluded from the sitemap. Hold Ctrl/Cmd to select multiple.', 'almaseo-seo-playground'); ?></p>
            </div>

            <div class="almaseo-form-group">
                <label for="exclude-authors"><?php esc_html_e('Exclude by Author', 'almaseo-seo-playground'); ?></label>
                ...
                <p class="description"><?php esc_html_e('Posts by selected authors will be excluded from the sitemap.', 'almaseo-seo-playground'); ?></p>
            </div>

            <div class="almaseo-form-group">
                <label for="exclude-older-than"><?php esc_html_e('Exclude Posts Older Than', 'almaseo-seo-playground'); ?></label>
                <select id="exclude-older-than" class="almaseo-input" style="width: auto;">
                    <option value="0" <?php selected($older_than_years, 0); ?>><?php esc_html_e('No limit (include all)', 'almaseo-seo-playground'); ?></option>
                    <option value="1" <?php selected($older_than_years, 1); ?>><?php esc_html_e('1 year', 'almaseo-seo-playground'); ?></option>
                    <option value="2" <?php selected($older_than_years, 2); ?>><?php esc_html_e('2 years', 'almaseo-seo-playground'); ?></option>
                    <option value="3" <?php selected($older_than_years, 3); ?>><?php esc_html_e('3 years', 'almaseo-seo-playground'); ?></option>
                    <option value="5" <?php selected($older_than_years, 5); ?>><?php esc_html_e('5 years', 'almaseo-seo-playground'); ?></option>
                    <option value="10" <?php selected($older_than_years, 10); ?>><?php esc_html_e('10 years', 'almaseo-seo-playground'); ?></option>
                </select>
                <p class="description"><?php esc_html_e('Older posts may be less relevant. Excluding them can reduce sitemap size.', 'almaseo-seo-playground'); ?></p>
            </div>
        </div>
    </div>
</div>
...
<div class="almaseo-card">
    <div class="almaseo-card-header">
        <h2><?php esc_html_e('Additional URLs', 'almaseo-seo-playground'); ?></h2>
    ...
    <div class="almaseo-card-body">
        <?php if ($additional_count > 0) : ?>
            ...
            <div id="additional-urls-list" class="almaseo-urls-list">
                ...
                <div class="almaseo-loading">
                    ...
                    <?php esc_html_e('Loading URLs...', 'almaseo-seo-playground'); ?>
                </div>
            </div>
        <?php else : ?>
            <div class="almaseo-empty-state">
                <span class="dashicons dashicons-admin-links"></span>
                <p><?php esc_html_e('No additional URLs added yet', 'almaseo-seo-playground'); ?></p>
                <p class="description"><?php esc_html_e('Add custom URLs to include in your sitemaps', 'almaseo-seo-playground'); ?></p>
            </div>
        <?php endif; ?>
        ...
        <div class="almaseo-button-group">
            <button type="button" class="button button-primary" id="add-url-btn">
                ...
                <?php esc_html_e('Add URL', 'almaseo-seo-playground'); ?>
            </button>
            <button type="button" class="button" id="import-csv-btn">
                <span class="dashicons dashicons-upload"></span>
                <?php esc_html_e('Import CSV', 'almaseo-seo-playground'); ?>
            </button>
            <?php if ($additional_count > 0) : ?>
            ...
            <button type="button" class="button" id="clear-all-urls-btn">
                ...
                <?php esc_html_e('Clear All', 'almaseo-seo-playground'); ?>
            </button>
            <?php endif; ?>
        </div>
            ...
            <table class="wp-list-table widefat fixed striped">
                <thead>
                    <tr>
                        ...
                        <th><?php esc_html_e('Change Frequency', 'almaseo-seo-playground'); ?></th>
                        <th><?php esc_html_e('Added', 'almaseo-seo-playground'); ?></th>
                ...
                <tbody id="additional-urls-table-body">
                    ...
                    <tr>
                        <td colspan="5" class="almaseo-loading">
                            <span class="dashicons dashicons-update spin"></span>
                            <?php esc_html_e('Loading additional URLs...', 'almaseo-seo-playground'); ?>
                        </td>
                    </tr>
                </tbody>
            </table>
