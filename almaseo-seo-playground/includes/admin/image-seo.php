                ...
                <tr>
                    ...
                    <td>
                        <label>
                            ...
                            <?php _e( 'Automatically add missing alt and title attributes', 'almaseo' ); ?>
                        </label>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><label for="img_alt_format"><?php _e( 'Alt Text Format', 'almaseo' ); ?></label></th>
                    <td>
                        ...
                        <p class="description"><?php _e( 'Tags: %%filename%%, %%sitename%%, %%post_title%%', 'almaseo' ); ?></p>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><label for="img_title_format"><?php _e( 'Title Format', 'almaseo' ); ?></label></th>
                    <td>
                        ...
                        <p class="description"><?php _e( 'Leave empty to skip title attribute. Tags: %%filename%%, %%sitename%%, %%post_title%%', 'almaseo' ); ?></p>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><?php _e( 'Strip File Extension', 'almaseo' ); ?></th>
                    <td>
                        <label>
                            <input type="checkbox" name="almaseo_image_seo_settings[strip_extension]" value="1" <?php checked( $s['strip_extension'] ); ?> />
                            <?php _e( 'Remove file extension from filename when generating text', 'almaseo' ); ?>
                        </label>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><?php _e( 'Override Existing', 'almaseo' ); ?></th>
                    <td>
                        <label>
                            <input type="checkbox" name="almaseo_image_seo_settings[override_existing]" value="1" <?php checked( $s['override_existing'] ); ?> />
                            <?php _e( 'Replace existing alt text (not recommended)', 'almaseo' ); ?>
                        </label>
                    </td>
                </tr>
            </table>
