...
class AlmaSEO_History_Loader {
    ...
    public function ajax_restore() {
        ...
        $version_id = isset($_POST['version_id']) ? intval(wp_unslash($_POST['version_id'])) : 0;
    ...
    public function ajax_compare() {
        ...
        $post_id = isset($_POST['post_id']) ? intval(wp_unslash($_POST['post_id'])) : 0;
        $from_version = isset($_POST['from_version']) ? intval(wp_unslash($_POST['from_version'])) : 0;
        $to_version = isset($_POST['to_version']) ? intval(wp_unslash($_POST['to_version'])) : 0;
